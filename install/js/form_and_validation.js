function checkweb(){
	...
	if(document.frm_sql.tablepre.value!=""){
		var reg= /^[A-Za-z]+$/;
		if (!reg.test(document.frm_sql.tablepre.value.substring(0,1))){
			document.getElementById('tablepre_msg').innerHTML="<font color=red>数据库表前缀只能以英文字母开头</font>";
